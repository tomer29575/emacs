...
;; @(#) $Id: specman-mode.el,v 1.1.1.1 2009-06-15 21:38:08 tomerl Exp $
;; @(#) $Keywords: tools $
...
;; 05-May-2000|$Revision: 1.1.1.1 $|~/misc/specman-mode.el.Z|
...
(defconst specman-mode-version "$$Revision: 1.1.1.1 $$"
...
(unless (boundp 'font-lock-constant-face)
  ...
  (set-face-foreground 'font-lock-constant-face "Red"));;TTLL"CadetBlue"))
